...
subj_dir = paths[0]
subj_batch = sorted(os.listdir(subj_dir))
...
cing_file = cing_files[0] #Edit cing region here!!!
...
for s in subj_batch:
    ...
    subj_code = str(s).split("_")[1].replace(".nii","")
    subj_nifti = os.path.join(subj_dir,s)
